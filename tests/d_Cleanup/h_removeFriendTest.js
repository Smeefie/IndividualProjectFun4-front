module.exports = {
    'Remove Friend for NightWatchUser': function(browser) {
        browser
        //.url(browser.launchUrl+'movies/')
            ...
            .assert.visible('/html/body/div/div[1]/main/div/div[3]/div/div/div[3]/div[2]/div/div[2]/button')
            .click('/html/body/div/div[1]/main/div/div[3]/div/div/div[3]/div[2]/div/div[2]/button')
